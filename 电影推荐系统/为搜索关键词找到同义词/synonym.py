...
if __name__ == '__main__':
    print('加载关键字..')
    # 加载关键字
    keywords_1 = load_keywords(r'F:\软微作业\研一下\大数据作业\part-00000')
    keywords_2 = load_keywords(r'F:\软微作业\研一下\大数据作业\part-00001')
    ...
    # 加载电影信息里，去重后所有的分词，共有
    movie_segs = load_movie_segs(r'F:\软微作业\研一下\大数据作业\code\对电影信息进行分词\movie_seg.txt')
    print('加载去重后的电影分词成功')
